  ...
  return (
    <section className="w-full py-24 px-4 flex flex-col items-center relative overflow-hidden" id="pricing">
      ...
      <div className="flex flex-col items-center text-center mb-16 max-w-3xl relative z-10">
        ...
        <h2 className="font-display font-black text-5xl md:text-7xl leading-[0.9] mb-6 uppercase">
        ...
        <div className="bg-white border-2 md:border-4 border-black shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] md:shadow-[16px_16px_0px_0px_rgba(0,0,0,1)] flex flex-col lg:flex-row relative">
            ...
            <div className="w-full lg:w-[40%] bg-[#FAFA9D] border-b-2 lg:border-b-0 lg:border-r-2 md:border-r-4 border-black p-8 md:p-12 flex flex-col relative overflow-hidden">
                ...
                <div className="relative z-10 flex-grow flex flex-col justify-center">
                    ...
                    <div className="mb-10 p-6 bg-white border-2 border-black shadow-neo-sm rounded-xl relative">
                        ...
                        <div className="flex flex-col items-center text-center">
                            <span className="font-sans font-bold text-gray-400 line-through text-lg decoration-2 decoration-red-500 mb-1">$89 original price</span>
                ...
                <div className="relative z-10 mt-auto">
                    <Button fullWidth variant="primary" size="lg" className="h-16 text-xl border-2 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] hover:translate-x-[2px] hover:translate-y-[2px] transition-all bg-black text-white hover:bg-gray-800">
                        Get Started Now
                    </Button>
...
const FeatureRow: React.FC<FeatureRowProps> = ({ icon, title, description }) => (
    <div className="flex items-start gap-5 group">
        <div className="w-12 h-12 rounded-xl bg-white border-2 border-black flex items-center justify-center flex-shrink-0 shadow-[3px_3px_0px_0px_rgba(0,0,0,1)] group-hover:bg-[#D6F5F2] group-hover:-translate-y-1 group-hover:shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] transition-all duration-200">
