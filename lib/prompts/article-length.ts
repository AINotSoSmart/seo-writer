...
export const ARTICLE_LENGTH_CONFIG: Record<ArticleLength, {
  ...
  short: { label: 'Short', wordRange: '1,200–1,800', sections: { min: 1, max: 5 }, wordsPerSection: '240–360', h2Limit: '1-5' },
  medium: { label: 'Medium', wordRange: '1,600–2,200', sections: { min: 1, max: 7 }, wordsPerSection: '230–360', h2Limit: '1-7' },
  long: { label: 'Long', wordRange: '2,400–3,200', sections: { min: 1, max: 10 }, wordsPerSection: '260–420', h2Limit: '1-10' },
